...
function haberYapici(haberler) {
  const existingArticles = document.querySelector(".articles");
  ...
  haberler.forEach((haber) => {
    ...
    existingArticles.appendChild(article);
  });
